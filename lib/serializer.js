...
module.exports = class CustomSerializer extends Serializer {
    ...
    constructor(node, options) {
        super(node, options);
        this.fullRendering = options.fullRendering !== undefined ? options.fullRendering : true;
    ...
    _serializeNode(currentNode) {
        if (this.fullRendering && !this.isPipeInserted && this._isPipeNode(currentNode)) {
        ...
        if (this.fullRendering && !this.lastChildInserted && this._isLastChildOfBody(currentNode)) {
            this._serializeRest();
        }
    }
