...
module.exports = class Transform {
     ...
     */
    applyTransforms(baseTemplate, childTemplate, addPlaceholders) {
        const rootNodes = parse5.parse(baseTemplate, { treeAdapter });
        const slotMap = childTemplate && typeof childTemplate === 'string'
            ? this._groupSlots(parse5.parseFragment(childTemplate, { treeAdapter }))
            : new Map();
