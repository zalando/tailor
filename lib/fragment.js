 ...
 * @param {object} defaultAttributes - Default values for the attributes
 * @returns {object}
 */
const getAttributes = (tag, context, defaultAttributes = {}) => {
    const attributes = Object.assign({}, defaultAttributes, tag.attributes);
...
module.exports = class Fragment extends EventEmitter {
    ...
    constructor(
        ...
        super();
        this.attributes = getAttributes(tag, context, defaultAttributes);
